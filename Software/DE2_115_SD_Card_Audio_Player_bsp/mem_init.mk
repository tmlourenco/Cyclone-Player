...
# Memory: av_tri_s1_cfi_flash_0
MEM_0 := av_tri_s1_cfi_flash_0
$(MEM_0)_NAME := av_tri_s1_cfi_flash_0
...
$(MEM_0)_HIERARCHICAL_PATH := av_tri_s1_cfi_flash_0
$(MEM_0)_WIDTH := 8
...
.PHONY: av_tri_s1_cfi_flash_0
av_tri_s1_cfi_flash_0: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash

# Memory: onchip_memory2
MEM_1 := DE2_115_SOPC_onchip_memory2
