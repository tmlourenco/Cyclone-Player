// altera_generic_tristate_controller_w4fjy22c.v

// This file was auto-generated from altera_generic_tristate_controller_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using SOPC Builder version 10.1sp1 197 at 2011.03.16.15:48:47

module altera_generic_tristate_controller_w4fjy22c #(
		...
		parameter ACTIVE_LOW_ARBITERLOCK         = 0,
		...
		input  wire        uas_arbiterlock,      //      .arbiterlock
	...
	wire         tdt_avalon_universal_master_0_burstcount;        // tdt:m0_uav_burstcount -> slave_translator:uav_burstcount
	...
	wire         tdt_avalon_universal_master_0_arbiterlock;       // tdt:m0_uav_arbiterlock -> slave_translator:uav_arbiterlock
	...
	wire         tdt_avalon_universal_master_0_byteenable;        // tdt:m0_uav_byteenable -> slave_translator:uav_byteenable
	...
	generate
		...
		begin
			...
			instantiated_with_wrong_parameters_error_see_comment_above
					use_arbiterlock_check ( .error(1'b1) );
		end
		if (USE_ADDRESS != 1)
		begin
			initial begin
		...
		begin
			...
			instantiated_with_wrong_parameters_error_see_comment_above
					active_low_arbiterlock_check ( .error(1'b1) );
		end
	...
	altera_tristate_controller_translator #(
		...
		.s0_uav_arbiterlock   (uas_arbiterlock),                             //                          .arbiterlock
		...
		.m0_uav_arbiterlock   (tdt_avalon_universal_master_0_arbiterlock),   //                          .arbiterlock
	...
	altera_merlin_slave_translator #(
		...
		.uav_arbiterlock       (tdt_avalon_universal_master_0_arbiterlock),       //                         .arbiterlock
	...
	altera_tristate_controller_aggregator #(
		...
		.tcm0_arbiterlock       (),                                                //               (terminated)
		.tcm0_arbiterlock_n     (),                                                //               (terminated)
